...
/**
 * Similarly to CircularShifter class, Alphabetizer class implemets the
 * "Observer" part of the standard "Observable"-"Observer" mechanism as well.
 * However, an object of Alphabetizer class "observes" a LineStorageWrapper
 * object, which keeps circular shifts, whereas an object of CircularShifter
 * class "observes" a LineStorageWrapper object, which keeps original lines from
 * a KWIC input file. Thus, an instance of Alphabetizer class declares its
 * interest in tracking changes in an object of LineStorageWrapper class holding
 * circular shifts. Therefore, any event produced and sent by that
 * LineStorageWrapper object whenever its internal state is changed (i.e.,
 * whenever a new circular shift has been added) is catched by Alphabetizer
 * object. In turn, this leads to sorting the circular shifts alphabetically.
 * 
 * @author dhelic
 * @version $Id$
 */
