...
/**
 * CircularShifter filter produces circular shifts of a set of lines passed to
 * it. The set of lines is read from the input pipe of this filter. The produced
 * shifts are written out to the output pipe of this filter.
 * 
 * @author dhelic
 * @version $Id$
 */
...
public class CircularShifter extends Filter
{
	...
	// ----------------------------------------------------------------------
	/**
	 * Produces all circular shifts of lines in a given set, read from the input
	 * pipe.
	 * 
	 * @return void
	 */
			...
			while (c != -1)
			{
				...
				if (((char) c) == '\n')
				{
					...
					for (i = 0; i < words.length; i++)
					{
						...
						// convert the shift into char array and write it to the
						// output
